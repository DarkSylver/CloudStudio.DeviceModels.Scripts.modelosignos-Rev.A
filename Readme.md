...
# Parsing + Configuration Script – modelo_signos - Rev. A

This **Parsing + Configuration** script is designed for the **modelo_signos** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – modelo_signos Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **modelo_signos** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
